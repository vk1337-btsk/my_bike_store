...
EMAIL_HOST_USER = config['data_email']['email_host_user']
EMAIL_HOST_PASSWORD = config['data_email']['email_host_password']
EMAIL_HOST_TO_USER = config['data_email']['email_host_to_user']
